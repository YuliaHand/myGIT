...
WebUI.click(findTestObject('3. Payment/Payment_CC/Checkbox_PromoInstallment'))

WebUI.verifyElementText(findTestObject('3. Payment/Payment_CC/Verify_Amount'), '20,000')
...
WebUI.verifyElementText(findTestObject('3. Payment/Payment_CC/Verify_Amount_IssuingBank'), '20000.00')
...
WebUI.verifyElementText(findTestObject('3. Payment/Payment_CC/Verify__TransactionSuccessful'), 'Transaction successful')
