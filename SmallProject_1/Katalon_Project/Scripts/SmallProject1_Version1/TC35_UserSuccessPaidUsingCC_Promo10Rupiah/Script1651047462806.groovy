...
WebUI.click(findTestObject('3. Payment/Payment_CC/Checkbox_Promo10rupiah'))

WebUI.verifyElementText(findTestObject('3. Payment/Payment_CC/Verify_Amount'), '19,990')
...
WebUI.verifyElementText(findTestObject('3. Payment/Payment_CC/Verify_Amount_IssuingBank'), '19990.00')
...
WebUI.verifyElementText(findTestObject('3. Payment/Payment_CC/Verify_TotalPrice'), 'Rp 19,990')
