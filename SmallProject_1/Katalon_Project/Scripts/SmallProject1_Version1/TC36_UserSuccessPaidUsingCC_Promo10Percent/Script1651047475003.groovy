...
WebUI.click(findTestObject('3. Payment/Payment_CC/Checkbox_Promo10Percent'))

WebUI.verifyElementText(findTestObject('3. Payment/Payment_CC/Verify_Amount'), '18,000')
...
WebUI.verifyElementText(findTestObject('3. Payment/Payment_CC/Verify_Amount_IssuingBank'), '18000.00')
...
WebUI.verifyElementText(findTestObject('3. Payment/Payment_CC/Verify_TotalPrice'), 'Rp 18,000')
