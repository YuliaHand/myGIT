...
WebUI.setText(findTestObject('3. Payment/Payment_CC/Field_CardNumber'), '')

WebUI.setText(findTestObject('3. Payment/Payment_CC/Field_ExpireDate'), '')

WebUI.setText(findTestObject('3. Payment/Payment_CC/Field_CVV'), '')

WebUI.click(findTestObject('3. Payment/Payment_CC/Checkbox_MasterCard'))

WebUI.verifyElementText(findTestObject('3. Payment/Payment_CC/Verify_Amount'), '19,000')
...
WebUI.verifyElementText(findTestObject('3. Payment/Payment_CC/Verify_Amount_IssuingBank'), '19000.00')
...
WebUI.verifyElementText(findTestObject('3. Payment/Payment_CC/Verify_TotalPrice'), 'Rp 19,000')
