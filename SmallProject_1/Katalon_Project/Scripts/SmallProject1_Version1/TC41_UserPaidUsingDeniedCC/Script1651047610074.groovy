...
WebUI.setText(findTestObject('3. Payment/Payment_CC/Field_CardNumber'), findTestData('Denied_CardNumber').getValue(
        1, 1))

WebUI.setText(findTestObject('3. Payment/Payment_CC/Field_ExpireDate'), findTestData('Denied_CardNumber').getValue(
        2, 1))

WebUI.setText(findTestObject('3. Payment/Payment_CC/Field_CVV'), findTestData('Denied_CardNumber').getValue(
        3, 1))
...
WebUI.verifyElementText(findTestObject('3. Payment/Payment_CC/Verify_YourCardDeclined'), 'Your card got declined by the bank')
