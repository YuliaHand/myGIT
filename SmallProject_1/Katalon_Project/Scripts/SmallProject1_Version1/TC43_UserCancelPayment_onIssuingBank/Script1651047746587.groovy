...
WebUI.click(findTestObject('3. Payment/Payment_CC/a_IssuingBank/Button_Cancel_IssuingBank'))

WebUI.verifyElementVisible(findTestObject('3. Payment/Payment_CC/a_IssuingBank/Verify_TransactionFailed'), 
