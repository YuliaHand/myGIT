...
String textSuccess = WebUI.getAttribute(findTestObject('3. Payment/Payment_CC/TextBlack_CardNumber'), 'class')

WebUI.click(findTestObject('3. Payment/Payment_CC/Button_PayNow'))

String textFailed = WebUI.getAttribute(findTestObject('3. Payment/Payment_KlikBCA/TextRed_UserID'), 'class')

WebUI.verifyNotMatch(textSuccess, textFailed, false)
