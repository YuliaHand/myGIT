...
WebUI.click(findTestObject('3. Payment/Payment_UOB/Button_UOBWeb'))

WebUI.verifyElementText(findTestObject('3. Payment/Payment_UOB/Header_UOBWeb'), 'UOB EZ Pay via UOB Web')
