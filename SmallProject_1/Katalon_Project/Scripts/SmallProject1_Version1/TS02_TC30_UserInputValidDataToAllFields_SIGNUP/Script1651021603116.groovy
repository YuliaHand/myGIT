...
WebUI.navigateToUrl('https://dashboard.midtrans.com/register')
...
WebUI.setText(findTestObject('2. Register/Field_BusinessEmail'), 'roby@gmail.com')

WebUI.setText(findTestObject('2. Register/Field_PhoneNum'), '085694281234')
