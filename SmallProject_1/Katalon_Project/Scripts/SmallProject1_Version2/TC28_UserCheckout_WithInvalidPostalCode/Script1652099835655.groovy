...
WebUI.setText(findTestObject('3. Checkout/Field_PostalCode'), '12345qwe#!')

WebUI.click(findTestObject('3. Checkout/Button_Checkout'))

WebUI.verifyElementVisible(findTestObject('3. Checkout/AlertMessage'), FailureHandling.STOP_ON_FAILURE)
