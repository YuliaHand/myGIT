...
WebUI.verifyElementText(findTestObject('4. Payment/Payment_CC/Verify_Promo'), 'Rp5.000')

String total1 = WebUI.verifyElementText(findTestObject('4. Payment/Payment_CC/Verify_Total_AfterPromo'), 'Rp15.000')

String total2 = WebUI.verifyElementText(findTestObject('5. PopUp Detail/Verify_TotalAmount_PopUp'), 'Rp15.000')
...
WebUI.verifyElementText(findTestObject('4. Payment/Payment_CC/a_IssuingBank/Verify_Amount_IssuingBank'), '15000.00')
...
WebUI.verifyElementText(findTestObject('4. Payment/Payment_CC/Verify_Success_TotalPrice'), 'Rp15.000')
