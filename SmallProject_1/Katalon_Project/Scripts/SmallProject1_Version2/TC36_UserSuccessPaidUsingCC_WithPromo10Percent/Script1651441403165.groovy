...
WebUI.enhancedClick(findTestObject('4. Payment/Payment_CC/Promo_10Persen'))
...
WebUI.verifyElementText(findTestObject('4. Payment/Payment_CC/a_IssuingBank/Verify_Amount_IssuingBank'), '18000.00')
...
WebUI.verifyElementText(findTestObject('4. Payment/Payment_CC/Verify_Success_TotalPrice'), 'Rp18.000')
