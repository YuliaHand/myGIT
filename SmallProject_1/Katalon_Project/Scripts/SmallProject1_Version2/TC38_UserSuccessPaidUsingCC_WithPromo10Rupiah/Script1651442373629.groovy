...
WebUI.enhancedClick(findTestObject('4. Payment/Payment_CC/Promo_10Rupiah'))
...
WebUI.verifyElementText(findTestObject('4. Payment/Payment_CC/Verify_Promo'), 'Rp10')

String total1 = WebUI.verifyElementText(findTestObject('4. Payment/Payment_CC/Verify_Total_AfterPromo'), 'Rp19.990')

String total2 = WebUI.verifyElementText(findTestObject('5. PopUp Detail/Verify_TotalAmount_PopUp'), 'Rp19.990')
...
WebUI.verifyElementText(findTestObject('4. Payment/Payment_CC/a_IssuingBank/Verify_Amount_IssuingBank'), '19990.00')
...
WebUI.verifyElementText(findTestObject('4. Payment/Payment_CC/Verify_Success_TotalPrice'), 'Rp19.990')
