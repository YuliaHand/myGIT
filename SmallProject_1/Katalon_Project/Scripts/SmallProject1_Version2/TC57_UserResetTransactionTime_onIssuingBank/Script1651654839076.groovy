...
WebUI.click(findTestObject('4. Payment/Payment_CC/a_IssuingBank/Button_Resend'))

WebUI.verifyElementText(findTestObject('4. Payment/Payment_CC/a_IssuingBank/Verify_ResetTransactionTime'), '04 : 59')
