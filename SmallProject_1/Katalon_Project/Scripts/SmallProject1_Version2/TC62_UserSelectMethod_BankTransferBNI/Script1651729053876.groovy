...
WebUI.click(findTestObject('4. Payment/Payment_ATMBankTransfer/Button_BNI'))

WebUI.delay(1)

WebUI.takeFullPageScreenshot()

WebUI.verifyElementText(findTestObject('4. Payment/a_Header_Details'), 'Bank BNI')

WebUI.verifyElementVisible(findTestObject('4. Payment/Payment_ATMBankTransfer/Desc_AllBank'))

WebUI.verifyElementVisible(findTestObject('4. Payment/Payment_ATMBankTransfer/VAnumber_BNI'))
