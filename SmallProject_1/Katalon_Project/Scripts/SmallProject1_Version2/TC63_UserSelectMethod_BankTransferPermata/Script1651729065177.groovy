...
WebUI.click(findTestObject('4. Payment/Payment_ATMBankTransfer/Button_Permata'))

WebUI.delay(1)

WebUI.takeFullPageScreenshot()

WebUI.verifyElementText(findTestObject('4. Payment/a_Header_Details'), 'Bank Permata')

WebUI.verifyElementVisible(findTestObject('4. Payment/Payment_ATMBankTransfer/Desc_AllBank'))

WebUI.verifyElementVisible(findTestObject('4. Payment/Payment_ATMBankTransfer/VAnumber_Permata'))
...
WebUI.click(findTestObject('4. Payment/Payment_ATMBankTransfer/Button_HTP_ATMPermata'))

WebUI.verifyElementText(findTestObject('4. Payment/Payment_ATMBankTransfer/Verify_Step1_ATMPermata'), 'Select other transactions on the main menu.')

WebUI.verifyElementText(findTestObject('4. Payment/Payment_ATMBankTransfer/Verify_Step2_ATMPermata'), 'Select payment.')

WebUI.verifyElementText(findTestObject('4. Payment/Payment_ATMBankTransfer/Verify_Step3_ATMPermata'), 'Select other payments.')

WebUI.verifyElementText(findTestObject('4. Payment/Payment_ATMBankTransfer/Verify_Step4_ATMPermata'), 'Select virtual account.')

WebUI.verifyElementText(findTestObject('4. Payment/Payment_ATMBankTransfer/Verify_Step5_ATMPermata'), 'Insert virtual account number, then confirm.')

WebUI.verifyElementText(findTestObject('4. Payment/Payment_ATMBankTransfer/Verify_Step6_ATMPermata'), 'Payment complete.')
