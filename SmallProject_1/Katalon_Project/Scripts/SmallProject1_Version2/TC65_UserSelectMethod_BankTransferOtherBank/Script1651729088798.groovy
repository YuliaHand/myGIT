...
WebUI.click(findTestObject('4. Payment/Payment_ATMBankTransfer/Button_OtherBank'))

WebUI.delay(1)

WebUI.takeFullPageScreenshot()

WebUI.verifyElementText(findTestObject('4. Payment/a_Header_Details'), 'Other bank')

WebUI.verifyElementVisible(findTestObject('4. Payment/Payment_ATMBankTransfer/Desc_AllBank'))

WebUI.verifyElementVisible(findTestObject('4. Payment/Payment_ATMBankTransfer/BankCode'))

WebUI.verifyElementVisible(findTestObject('4. Payment/Payment_ATMBankTransfer/VAnumber_OtherBank'))

WebUI.verifyElementClickable(findTestObject('4. Payment/Payment_ATMBankTransfer/Button_Copy_ATMB'))
...
WebUI.verifyElementClickable(findTestObject('4. Payment/Payment_ATMBankTransfer/Button_HTP_Prima'))

WebUI.verifyElementPresent(findTestObject('4. Payment/Payment_ATMBankTransfer/Verify_Logo_Prima'), 0)

WebUI.verifyElementPresent(findTestObject('4. Payment/Payment_ATMBankTransfer/Verify_Steps_Prima'), 0)

WebUI.verifyElementClickable(findTestObject('4. Payment/Payment_ATMBankTransfer/Button_HTP_ATMBersama'))

WebUI.verifyElementPresent(findTestObject('4. Payment/Payment_ATMBankTransfer/Verify_Steps_ATMBersama'), 0)

WebUI.verifyElementClickable(findTestObject('4. Payment/Payment_ATMBankTransfer/Button_HTP_Alto'))

WebUI.verifyElementPresent(findTestObject('4. Payment/Payment_ATMBankTransfer/Verify_Steps_Alto'), 0)

WebUI.click(findTestObject('4. Payment/Payment_ATMBankTransfer/Button_IHavePaid_ATMB'))
