...
WebUI.verifyElementVisible(findTestObject('4. Payment/Payment_eWallet/Title_Gopay'))

WebUI.verifyElementVisible(findTestObject('4. Payment/Payment_eWallet/Logo_Gopay'))

WebUI.click(findTestObject('4. Payment/Payment_eWallet/Button_GOPAY'))

WebUI.delay(1)

WebUI.takeFullPageScreenshot()

WebUI.verifyElementText(findTestObject('4. Payment/a_Header_Details'), 'GoPay')
...
WebUI.verifyElementText(findTestObject('4. Payment/Payment_eWallet/Verify_Step1_eWallet'), 'Open your Gojek or other e-wallet apps.')
