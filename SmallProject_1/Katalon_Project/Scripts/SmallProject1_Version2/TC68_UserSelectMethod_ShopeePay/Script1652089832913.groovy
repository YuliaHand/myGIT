...
WebUI.verifyElementVisible(findTestObject('4. Payment/Payment_eWallet/Title_ShopeePay'))

WebUI.verifyElementVisible(findTestObject('4. Payment/Payment_eWallet/Logo_ShopeePay'))

WebUI.click(findTestObject('4. Payment/Payment_eWallet/Button_ShopeePay'))

WebUI.delay(1)

WebUI.takeFullPageScreenshot()

WebUI.verifyElementText(findTestObject('4. Payment/a_Header_Details'), 'ShopeePay')

WebUI.verifyElementVisible(findTestObject('4. Payment/Payment_eWallet/a_IMG_QR_eWallet'), FailureHandling.STOP_ON_FAILURE)
...
WebUI.verifyElementText(findTestObject('4. Payment/Payment_eWallet/Verify_Step1_eWallet'), 'Open your Shopee or other e-wallet app.')

WebUI.verifyElementText(findTestObject('4. Payment/Payment_eWallet/Verify_Step2_eWallet'), 'Scan the QR code on your monitor.')

WebUI.verifyElementText(findTestObject('4. Payment/Payment_eWallet/Verify_Step3_eWallet'), 'Confirm payment in the app.')

WebUI.verifyElementText(findTestObject('4. Payment/Payment_eWallet/Verify_Step4_eWallet'), 'Payment complete.')
