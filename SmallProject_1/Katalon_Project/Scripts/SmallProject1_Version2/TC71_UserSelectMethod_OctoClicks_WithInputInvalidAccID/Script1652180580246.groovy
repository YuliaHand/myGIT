...
WebUI.setText(findTestObject('4. Payment/Payment_eWallet/Field_AccID'), 'asd123!#$')

WebUI.click(findTestObject('4. Payment/Payment_eWallet/Button_Bayar'))

WebUI.verifyElementText(findTestObject('4. Payment/Payment_Akulaku/Verify_Trx_Failed'), 'Transaksi Gagal')
