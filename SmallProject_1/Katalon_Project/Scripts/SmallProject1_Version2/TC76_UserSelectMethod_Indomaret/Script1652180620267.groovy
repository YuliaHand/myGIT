...
WebUI.verifyElementVisible(findTestObject('4. Payment/Payment_Mart/Title_Indomaret'))

WebUI.verifyElementVisible(findTestObject('4. Payment/Payment_Mart/Logo_Indomaret'))

WebUI.click(findTestObject('4. Payment/Payment_Mart/Button_Indomaret'))

WebUI.delay(1)

WebUI.takeFullPageScreenshot()

WebUI.verifyElementText(findTestObject('4. Payment/a_Header_Details'), 'Indomaret')
...
WebUI.verifyElementText(findTestObject('4. Payment/Payment_Mart/Verify_Step2_Mart'), 'If you’re going to pay on the counter, go to the nearest Indomaret store and show your payment code/barcode to the cashier.')

WebUI.verifyElementText(findTestObject('4. Payment/Payment_Mart/Verify_Step3_Mart'), 'The cashier will confirm your transaction details. Once your transaction is successful, you’ll receive the payment confirmation e-mail.')

WebUI.verifyElementText(findTestObject('4. Payment/Payment_Mart/Verify_Step4_Mart'), 'If you’re going to pay via i.saku, open the app and tap Bayar.')

WebUI.verifyElementText(findTestObject('4. Payment/Payment_Mart/Verify_Step5_Mart'), 'Choose the merchant you’d like to pay to, and enter your payment code.')

WebUI.verifyElementText(findTestObject('4. Payment/Payment_Mart/Verify_Step6_Mart'), 'Tap Selanjutnya and check your transaction details.')

WebUI.verifyElementText(findTestObject('4. Payment/Payment_Mart/Verify_Step7_Mart'), 'Tap Bayar sekarang to confirm your payment.')

WebUI.verifyElementText(findTestObject('4. Payment/Payment_Mart/Verify_Step8_Mart'), 'Please keep your Indomaret payment receipt in case you’ll need further help via support.')
