...
WebUI.setText(findTestObject('4. Payment/Payment_Akulaku/Field_Phone_Akulaku'), findTestData('Akulaku_PhoneNumber').getValue(
        2, 1))

WebUI.click(findTestObject('4. Payment/Payment_Akulaku/Button_Next'))

WebUI.verifyElementVisible(findTestObject('4. Payment/Payment_Akulaku/Verify_RefNo'))

WebUI.click(findTestObject('4. Payment/Payment_Akulaku/Button_Pay'))

WebUI.verifyElementText(findTestObject('4. Payment/Payment_Akulaku/Verify_Trx_Pending'), 'Transaction is Pending')

WebUI.click(findTestObject('4. Payment/Payment_Akulaku/Button_ThisPage'))

WebUI.verifyElementVisible(findTestObject('4. Payment/Payment_Akulaku/Verify_PaymentCode'))

WebUI.click(findTestObject('4. Payment/Payment_Akulaku/Button_Submit'))

WebUI.verifyElementText(findTestObject('4. Payment/Payment_Akulaku/Verify_Trx_Success'), 'Transaction is Successful')
