...
WebUI.setText(findTestObject('4. Payment/Payment_Akulaku/Verify_PaymentCode'), '12ab')

WebUI.click(findTestObject('4. Payment/Payment_Akulaku/Button_Submit'))

WebUI.verifyElementText(findTestObject('4. Payment/Payment_Akulaku/Verify_Trx_Failed'), 'Transaction Not Found')
