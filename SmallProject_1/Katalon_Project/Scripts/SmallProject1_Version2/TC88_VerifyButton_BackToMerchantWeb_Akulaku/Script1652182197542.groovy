...
WebUI.setText(findTestObject('4. Payment/Payment_Akulaku/Field_Phone_Akulaku'), findTestData('Akulaku_PhoneNumber').getValue(1, 1))
...
WebUI.click(findTestObject('4. Payment/Payment_Akulaku/Button_BackToMerchant'))

WebUI.delay(3)

def url = WebUI.getUrl()

WebUI.verifyEqual(url, 'https://demo.midtrans.com/')
