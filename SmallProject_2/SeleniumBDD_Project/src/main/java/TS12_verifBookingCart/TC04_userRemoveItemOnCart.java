...
public class TC04_userRemoveItemOnCart extends listener{

    @Test
    public void removeItemCart() throws InterruptedException {

        // TC04 - USER REMOVE ITEM ON BOOKING CART
        ...
        //17. User remove item on the booking cart
        driver.findElement(By.xpath("//*[@id=\"header\"]/div[3]/div/div/div[4]/div/a/span[1]")).click();
        wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//*[@id=\"collapse-shopping-cart\"]/div/div[2]/div[1]/div[1]/p[2]/a"))).click();

        String alertWarning = "Till now you did not added any room in your cart.";
        String actualAlertW =  driver.findElement(By.xpath("//*[@id=\"content\"]/div/p")).getText();

        assertEquals(alertWarning,actualAlertW);
    }
}