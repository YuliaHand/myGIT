...
public class TC26_userSuccessBookRoomCheckPayment extends listener {

    @Test
    public void checkPayment() throws InterruptedException {

        // TC26 - USER SUCCESSFULLY BOOK A ROOM and SELECT CHECK PAYMENT
        ...
        //21. User Successfully book a room by check payment
