...
public class TC28_userSuccessBookRoomByPaypal extends listener {

    @Test
    public void payByPaypal() throws InterruptedException {

        // TC28 - USER SUCCESSFULLY BOOK A ROOM with PAY BY PAYPAL
       ...
       //14. User Click Book Now button
        ...
        //15. User Click Proceed to checkout button
        ...
        //19. User Select pay by paypal
        Thread.sleep(3000);
        driver.findElement(By.partialLinkText("Pay with your card")).click();
        ...
        //21. User Successfully book a room By Paypal Payment
