...
public class TC27_userSuccessBookRoomByBankWire extends listener {

    @Test
    public void payByBankWire() throws InterruptedException {

        // TC27 - USER SUCCESSFULLY BOOK A ROOM with PAY BY BANK WIRE
       ...
       //14. User Click Book Now button
        ...
        //19. User Select pay by bank wire
        Thread.sleep(3000);
        ...
        //21. User Successfully book a room By Bank Wire Payment
