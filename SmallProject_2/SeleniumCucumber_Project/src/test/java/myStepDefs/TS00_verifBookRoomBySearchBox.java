...
public class TS_verifBookRoomBySearchBox {
    ...
    public void userSelectCheckInAndCheckOutDate() throws Throwable{
        ...
        driver.findElement(By.xpath("//*[@id=\"ui-datepicker-div\"]/div/a[2]/span")).click();
        driver.findElement(By.xpath("//*[@id=\"ui-datepicker-div\"]/div/a[2]/span")).click();
        WebElement dateWidgetFrom = wait.until(ExpectedConditions.presenceOfAllElementsLocatedBy(By.className("ui-state-default"))).get(26);
        dateWidgetFrom.click();

        driver.findElement(By.id("check_out_time")).click();
        WebElement dateWidgetTo = wait.until(ExpectedConditions.presenceOfAllElementsLocatedBy(By.className("ui-state-default"))).get(27);
        dateWidgetTo.click();
    ...
    public void userAlreadySearchHotel() throws InterruptedException{
        driver.findElement(By.xpath(("//*[@id=\"center_column\"]/ul/li/a"))).click();
        WebElement searchBox = driver.findElement(By.xpath("//*[@id=\"xs_room_search_form\"]/div/div[2]/div"));
        ((JavascriptExecutor) driver).executeScript("arguments[0].scrollIntoView(true);", searchBox);

        //User Input hotel name on Hotel Location field
        driver.findElement(By.id("hotel_location")).sendKeys("Aceh");
        Thread.sleep(6000);

        //User Select hotel name on Select Hotel field
        driver.findElement(By.id("id_hotel_button")).click();
        Thread.sleep(3000);
        WebElement hotelName = wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//*[@id=\"search_hotel_block_form\"]/div[2]/div/ul")));
        hotelName.click();
        ...
        //User Select check in and check out date
        driver.findElement(By.id("check_in_time")).click();
        driver.findElement(By.xpath("//*[@id=\"ui-datepicker-div\"]/div/a[2]/span")).click();
        driver.findElement(By.xpath("//*[@id=\"ui-datepicker-div\"]/div/a[2]/span")).click();
        driver.findElement(By.xpath("//*[@id=\"ui-datepicker-div\"]/div/a[2]/span")).click();
        ...
        //User Click Search Now button
        driver.findElement(By.id("search_room_submit")).click();

        //User directed to search rooms page
        Thread.sleep(7000);
        String t = "Search Rooms";
        // identify elements with text()
        List<WebElement> l= driver.findElements(By.xpath("//*[contains(text(),'Search Rooms')]"));
    ...
    public void userClickIConfirmMyOrder() throws InterruptedException{
        ...
        if (amount == "1 100,00 Rp"){
            System.out.println("Silakan membayar sebesar " +amount+ "untuk book General Rooms selama 1 hari");
        } else {
